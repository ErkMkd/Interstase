...
void main( void )
{
    ...
    gl_ClipVertex = gl_ModelViewMatrix * gl_Vertex; // Activation des plans de clipping
	vec3 position_sommet = (gl_ModelViewMatrix * gl_Vertex).xyz;
    coordonnees_textures     = gl_MultiTexCoord0.xy;
   ...
   //--------- Calcul de l'éclairage:
	...
	vec3 direction_source =normalize((gl_LightSource[0].position).xyz);
