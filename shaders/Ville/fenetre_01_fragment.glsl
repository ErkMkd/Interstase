...
void main( void )
{
    ...
    if(normalAbs.y!=0.)
    {
        ...
        couleur_texture=couleur_rgba*0.75;
    }

    else
    {

        yPos=int(coords_pixel.y/hauteur_etage*2);
        if(yPos==nombre_etages*2-1)
        {
            couleur_texture=couleur_rgba*.75;
        }
        else if(coords_pixel.z>-.5 && coords_pixel.z<.5) couleur_texture=couleur_rgba*.75;
        else if(coords_pixel.x>-.5 && coords_pixel.x<.5) couleur_texture=couleur_rgba*.75;
